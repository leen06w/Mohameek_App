...
class _LawyerDashboardScreenState extends State<LawyerDashboardScreen> {
  ...
  final List<_LawyerStat> stats = const [
    _LawyerStat(
      label: 'الاستشارات',
      value: '24',
  ...
  void _seedNotifications() {
    _notifications = [
      const _LawyerNotificationItem(
        ...
        body: 'وردك طلب جديد من نورة عبدالله في قضية أسرية.',
        time: 'الآن',
      ...
      const _LawyerNotificationItem(
        ...
        body: 'استلمت رسالة جديدة بخصوص استشارة عن بعد.',
        time: 'قبل 8 دقائق',
        icon: Icons.mark_chat_unread_rounded,
        type: _LawyerNotificationType.message,
        isUnread: true,
      ),
      const _LawyerNotificationItem(
