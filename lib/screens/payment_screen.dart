...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  BookingDetails? get bookingDetails =>
      widget.details is BookingDetails ? widget.details as BookingDetails : null;
  ...
  Future<void> _processPayment() async {
    if (!otpComplete || isProcessing) return;
    ...
    return SectionCard(
      child: Column(
        children: [
          ...
          const SizedBox(height: 20),
          PrimaryButton(
            text: isProcessing ? 'جاري المعالجة...' : 'تأكيد الدفع',
            onPressed: otpComplete && !isProcessing ? _processPayment : null,
          ),
          TextButton(
            onPressed: () {},
