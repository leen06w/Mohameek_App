...
class MockData {
  static const demoCredentials = {
    'user@test.com': {'password': '123', 'role': 'user', 'path': '/user/dashboard'},
    'lawyer@test.com': {'password': '123', 'role': 'lawyer', 'path': '/lawyer/dashboard'},
    'admin@test.com': {'password': '123', 'role': 'admin', 'path': '/admin/dashboard'},
  };
  ...
  static const List<Lawyer> lawyers = [
    Lawyer(
      ...
      bio: 'محامٍ مرخص متخصص في القانون التجاري والشركات بخبرة تزيد عن 15 عاماً في المحاماة والاستشارات القانونية.',
    ...
    Lawyer(
      ...
      bio: 'متخصصة في قضايا الأسرة والأحوال الشخصية وصياغة الاتفاقيات الأسرية وتسوية النزاعات بالطرق الودية والقضائية.',
    ...
    Lawyer(
      ...
      bio: 'متخصص في القضايا الجنائية وتمثيل المتقاضين أمام المحاكم والنيابات مع خبرة واسعة في الاستشارات الوقائية.',
    ...
    Lawyer(
      ...
      bio: 'خبرة في المنازعات العقارية وصياغة عقود البيع والإيجار والفرز والتطوير العقاري.',
    ...
    Lawyer(
      ...
      bio: 'يعالج قضايا الفصل التعسفي والحقوق العمالية والعقود وسياسات الامتثال في المنشآت.',
  ...
  static const List<RequestItem> requests = [
    RequestItem(
      ...
      description: 'أحتاج استشارة قانونية حول عقد شراكة تجارية جديدة وتوزيع الأرباح.',
      status: 'accepted',
    ...
    RequestItem(
      ...
      price: '600',
      negotiationNote: 'المحامي يقترح تغيير الموعد إلى 2026-04-10 الساعة 03:00 مساءً. الرسوم: 600 ر.س',
    ),
    RequestItem(
      id: '3',
